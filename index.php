    ...
    <div class="container">
        ...
        <div class="skills-grid">
            <div class="skill-category">
                ...
                <div class="skill-item">
                    <span class="skill-name">
                        <img src="image/node-js.png" class="skill-icon" alt="Node JS">
                    </span>
                    <div class="skill-bar" data-skill-level="Expert"><div class="skill-progress" style="width: 70%"></div></div>
                </div>
                <div class="skill-item">
                    <span class="skill-name">
                        <img src="image/express-js.png" class="skill-icon" alt="Express JS">
                    </span>
                ...
                <div class="skill-item">
                    <span class="skill-name">
                        <img src="image/firebase.png" class="skill-icon" alt="Firebase">
                    </span>
            ...
            <div class="skill-category">
                ...
                <div class="skill-item">
                    <span class="skill-name">
                        <img src="image/mongodb.png" class="skill-icon" alt="MongoDB">
                    </span>
                    <div class="skill-bar" data-skill-level="Intermediate"><div class="skill-progress" style="width: 88%"></div></div>
                </div>
            </div>
            ...
            <div class="skill-category">
                ...
                <div class="skill-item">
                    <span class="skill-name">
                        <img src="image/github.gif" class="skill-icon" alt="Github">
                    </span>
                    <div class="skill-bar" data-skill-level="Intermediate"><div class="skill-progress" style="width: 97%"></div></div>
                </div>
                <div class="skill-item">
                    <span class="skill-name">
                        <img src="image/git.png" class="skill-icon" alt="Git">
                    </span>
                    <div class="skill-bar" data-skill-level="Intermediate"><div class="skill-progress" style="width: 88%"></div></div>
                </div>
                <div class="skill-item">
                    <span class="skill-name">
                        <img src="image/cpanel.png" class="skill-icon" alt="cPanel">
                    </span>
                    <div class="skill-bar" data-skill-level="Intermediate"><div class="skill-progress" style="width: 77%"></div></div>
                </div>
                <div class="skill-item">
                    <span class="skill-name">
                        <img src="image/hpanel.png" class="skill-icon" alt="hPanel">
                    </span>
                    <div class="skill-bar" data-skill-level="Intermediate"><div class="skill-progress" style="width: 96%"></div></div>
                </div>
                <div class="skill-item">
                    <span class="skill-name">
    ...
    <section id="projects">
        <div class="container">
            ...
            <div class="projects-grid">
                ...
                <div class="project-card">
                    <div class="project-image">
                        <img src="image/babor.png" alt="M/S Babor Traders Credit Management Portal">
                    </div>
                    <div class="project-content">
                        <h3 class="project-title">M/S Babor Traders Credit Management Portal</h3>
<p class="project-description">A modern and user-friendly portal designed to efficiently track and manage credit transactions, outstanding balances, and customer information for M/S Babor Traders. Fast, reliable, and easy to use.</p>
<div class="project-tech">
    <span class="tech-tag">HTML</span>
    <span class="tech-tag">CSS3</span>
    <span class="tech-tag">JavaScript</span>
    ...
    <span class="tech-tag">Tailwind CSS</span>
                        ...
                        <div class="project-links">
                            <!-- <a href="#" class="project-link">Case Study</a> -->
                            <a href="https://babortraders.netlify.app" class="project-link">Live Demo</a>
                            <!-- <a href="#" class="project-link">GitHub</a> -->
                        </div>
                    </div>
                </div>
                <div class="project-card">
                    <div class="project-image">
                        <img src="image/coming.jpg" alt="Digital Notice Board System for Educational Institutes">
                    </div>
                    <div class="project-content">
...
<div class="project-tech">
    ...
    <span class="tech-tag">Bootstrap</span>
                ...
                <div class="project-card">
                    <div class="project-image">
                        <img src="image/coming.jpg" alt="E-Commerce Platform">
                    </div>
                    <div class="project-content">
    ...
    <footer>
        <div class="container footer-content">
            ...
            <div class="social-links">
                ...
                <a href="https://hello.smsamiulhasan@gmail.com/" class="social-link">
